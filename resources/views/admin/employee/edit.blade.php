                        ...
                        <form method="POST" action="{{ route('profile.update', $user->id) }}"  enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="personal_email" type="email" id="email" class="form-control" value="{{ old('personal_email', $user->userProfile ? $user->userProfile->personal_email : '') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="aadhar_number" class="control-label">Aadhar Number<small class="text-danger required">*</small></label>
