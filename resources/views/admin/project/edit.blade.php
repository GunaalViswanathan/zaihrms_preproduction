...
<div class="row">
    <div class="col-xl-12">
        <div class="card shadow mb-4">
            <div class="card-body">
                <div class="card-body">
                    <a href="{{ route('project.index') }}" title="Back to User List" class="btn btn-warning btn-sm"><i aria-hidden="true" class="fa fa-arrow-left"></i> Back to Project List</a>
                    <br> <br>
                    <form method="POST" action="{{ route('project.update',$project->id) }}" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="project_name" type="text" id="project-name" class="form-control" value="{{ old('project_name',$project->project_name) }}">
                                    @error('project_name')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="start_date" type="date" id="start_date" class="form-control" value="{{ old('start_date',$project->start_date) }}">
                                    @error('start_date')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="end_date" type="date" id="end_date" class="form-control" value="{{ old('end_date',$project->end_date) }}">
                                    @error('end_date')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="allocated_hours" type="text" id="allocated_hours" class="form-control" value="{{ old('allocated_hours',$project->allocated_hours) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="client_name" type="text" id="client-name" class="form-control" value="{{ old('client_name',$project->client_name) }}">
                                    @error('client_name')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="client_company" type="text" id="client_company" class="form-control" value="{{ old('client_company',$project->client_name) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="mail" type="mail" id="mail" class="form-control" min="0" value="{{ old('mail',$project->client_email) }}">
                                    @error('mail')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="project_type" class="form-control" id="project_type">
                                        ...
                                        <option @if(old('project_type', $project->project_type) == $type) selected @endif value="{{ $type}}">{{ $option['label'] }}</option>
                                        @endforeach
                                    </select>
                                    @endif
                                    @error('project_type')
                            ...
                            <div class="col-md-4 profile-status">
                                <div class="form-group">
                                    ...
                                    <select name="project_status" class="form-control" id="project_status">
                                        ...
                                        <option @if(old('project_status', $project->project_status) == $index) selected @endif value="{{ $index}}">{{ $option['label'] }}</option>
                                        @endforeach
                                    </select>
                                    @endif
                            ...
                            <div class="row">
                                ...
                                @foreach($value->employee as $key=>$resource)
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <input type="checkbox" id="resource" name="resource[]" value="{{ $resource->id }}" @if(in_array($resource->id,explode(',',$project->resource))) checked @endif> {{$resource->full_name}}
                                    </div>
                                </div>
                                @endforeach
                                @endforeach<br>
