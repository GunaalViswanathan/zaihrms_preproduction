<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
   ...
   <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
         ...
         <span class="mr-2 d-none d-lg-inline text-gray-600 small" style="color: white !important;">{{ auth()->user()->userProfile ? ucwords(auth()->user()->userProfile->first_name .' '. auth()->user()->userProfile->last_name) : '- NA -' }}</span>
