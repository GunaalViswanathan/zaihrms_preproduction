...
<ul class="menus main" id="accordionSidebar">
    ...
    <ul class="navbar-nav sub-menu">
        ...
        $role = LaraSnap\LaravelAdmin\Models\Role::where('name', 'employee')->first();
        $admin = LaraSnap\LaravelAdmin\Models\Role::where('name','super-admin')->first();
        $users = App\Models\User::where('id',$curUser)->first();
        
        @endphp
        @if($users->reporting_to != $admin->id && !(userHasRole('super-admin')) || $users->email == config('larasnap.module_list.hr2'))
