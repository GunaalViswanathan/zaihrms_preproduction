 ...
 @endcanAccess
   ...
   <input type="text" name="search" placeholder="Search Policy..." class="form-control ml-10" value="{{ $filters['search'] }}" data-toggle="tooltip" data-placement="top" title="Search by title">
   @endif
